...
### Fixed
- Parse red VERIFY failing-test names through the active language pack's Vitest, pytest, or Gradle/JUnit adapter, and refuse unknown adapters with an escalation instruction

...
Enforced by `wt-guard-recurrence-hook.mjs` (SessionStart: surfaces a guard's weekly firing count past the threshold, points at `wt-guard-journal-scan.mjs` for the full picture).

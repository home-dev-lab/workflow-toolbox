...
- `references/shipped-compositions.md` — the 22 shipped compositions + operational lessons.
...
Twenty-two shipped compositions cover every pattern in production shape. **Read

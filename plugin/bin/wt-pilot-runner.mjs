...
function usage() {
  return 'Usage: node wt-pilot-runner.mjs --card <id> --dir <worktree> --card-file <path> [--knowledge-base-index <path>] [--profile-env <settings.json>] [--contract <path>] [--hard] [--mailbox <path>] [--timeout 5400]'
}

...
function usage() {
  return 'Usage: node wt-pilot-runner.mjs --card <id> --dir <worktree> --card-file <path> [--board-contract <json file>] [--knowledge-base-index <path>] [--archive-root <project root>] [--plugin-dir <absolute-path>]... [--profile-env <settings.json>] [--contract <path>] [--hard] [--mailbox <path>] [--timeout 5400]'
}

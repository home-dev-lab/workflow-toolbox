...
const DEFINITIONS = Object.freeze({
  ...
  grounding_sources: { envKey: null, type: 'string', defaultValue: null },
  grounding_prompt_cooldown: { envKey: null, type: 'number', defaultValue: 5 },
  grounding_pre_send: { envKey: null, type: 'string', defaultValue: 'observe' },
  grounding_outbound_tools: { envKey: null, type: 'string', defaultValue: '' },
  ...
  executor_critic_variant: { envKey: 'WT_EXECUTOR_CRITIC_VARIANT', type: 'string', defaultValue: 'max' },

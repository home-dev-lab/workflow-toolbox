...
const DEFINITIONS = Object.freeze({
  ...
  pilot_hard_model: { envKey: 'WT_PILOT_HARD_MODEL', type: 'string', defaultValue: 'fable' },
...
const EXECUTOR_DEFAULT_DESCRIPTIONS = {
  executor_critic_model: 'claude-sdk opus / hard fable; gpt-lane openai/gpt-5.6-sol / hard openai/gpt-6-astra',
  ...
  executor_refutation_model: 'claude-sdk opus / hard fable; gpt-lane openai/gpt-6-astra / hard openai/gpt-6-astra',
}

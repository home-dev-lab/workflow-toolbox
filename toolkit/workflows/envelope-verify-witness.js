export const meta = {
  ...
  "phases": [
    {
      "title": "Verify",
      "detail": "adversarialVerification — one envelope verifier, one vote"
    }
  ]
}
var __wt = (() => {
  ...
  // envelope-verify-witness.workflow.ts
  var envelope_verify_witness_workflow_exports = {};
  __export(envelope_verify_witness_workflow_exports, {
    default: () => envelope_verify_witness_workflow_default
  });
...
${renderClaim(claim)}`;
  ...
  var envelope_verify_witness_workflow_default = defineWorkflow({
    meta: {
      name: "envelope-verify-witness",
      description: "Witness run \u2014 adversarialVerification with the verifier role on the thin envelope, one claim, one vote, one phase",
      whenToUse: "Only to measure the thin envelope inside adversarialVerification (envelope ladder, matrix row 5). Not a task workflow.",
  ...
  return __toCommonJS(envelope_verify_witness_workflow_exports);
})();
